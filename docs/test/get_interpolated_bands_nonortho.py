...
#get H(k)
if redo_Hk:
    Hk_nonortho = lib.build_Hk_4(nawf,nkpnts,nspin,shift,eigsmat,shift_type,U,Hk_space,Hk_outfile,Sks=Sks,nbnds_norm=nbnds_norm)
else:
    Hk_nonortho = np.load(Hk_outfile)['Hks']
...
if redo_HR:
    ...
    #Wigner-Seitz cell
    HR_ws_mat, _ ,_   = lib.build_HR_serial(nk1,nk2,nk3,QE_xml_data_file,HR_outfile,Hk_nonortho,Hk_space,nproc=nproc,cell_type='wigner-seitz')
